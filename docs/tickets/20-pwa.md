...
> ステータス: 進行中（Phase 1実装済み、iPhone Chrome確認済み、他端末未確認）

## 概要
スマホ利用を主とする前提に合わせ、びーびー日記をホーム画面追加可能なPWAとして整備する。
...
- [x] iPhone Chromeでホーム画面追加とstandalone起動を確認
...
- [x] iPhone Chromeでホーム画面からstandalone表示で起動する
